...
int main(int argc, char* argv[]) {
    ...
    const std::string T2KFile1{"../data/prob/T2Kprob4D-2-2.dat"};
    const std::string T2KFile2{"../data/prob/T2Kprobcir4-2-2.dat"};
    const std::string T2KFile3{"../data/prob/T2Kprobcir8-2-2.dat"};
    const std::string T2KFile4{"../data/prob/T2Kprobmuir1-2-2.dat"};
    const std::string T2KFile5{"../data/prob/T2Kprobmuir1.5-2-2.dat"};
    ...
    double ldm = 2.4634e-3 + sdm; // IO

    // /*parameters for NOvA*/
    // double theta12 = asin(sqrt(0.307));   // 2108
    // double theta13 = asin(sqrt(0.02224)); // 2108
    // double theta23 = asin(sqrt(0.56));    // 2108 result
    // double deltacp = 1.52 * M_PI;         // 2108 result
    // double sdm = 7.49e-5;                 // 2108
    // double ldm = 2.45e-3;                 // 2108 result
    ...
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(1, -10, ldm - sdm), LED::CalProbability::GLB_MU1R);
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(1, -10, ldm), LED::CalProbability::GLB_MU2R);
    ...
    for (int i = 1; i <= 2000; i++) {
        const double prob = glbFilteredConstantDensityProbability(0, 2, 2, -1, i * 0.002);
    ...
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -4, ldm - sdm), LED::CalProbability::GLB_MU1R);
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -4, ldm), LED::CalProbability::GLB_MU2R);
    glbSetOscParams(central_values, 0.1, LED::CalProbability::GLB_MU3R);
    glbSetOscillationParameters(central_values);
    glbSetRates();
    ...
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -8, ldm - sdm), LED::CalProbability::GLB_MU1R);
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -8, ldm), LED::CalProbability::GLB_MU2R);
    glbSetOscParams(central_values, 0.1, LED::CalProbability::GLB_MU3R);
    glbSetOscillationParameters(central_values);
    glbSetRates();
    ...
    glbSetOscParams(central_values, -10, LED::CalProbability::GLB_C2R);
    glbSetOscParams(central_values, 10, LED::CalProbability::GLB_C3R);
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -10, ldm - sdm), LED::CalProbability::GLB_MU1R);
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -10, ldm), LED::CalProbability::GLB_MU2R);
    glbSetOscParams(central_values, 1, LED::CalProbability::GLB_MU3R);
    glbSetOscillationParameters(central_values);
    glbSetRates();
    ...
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -10, ldm - sdm), LED::CalProbability::GLB_MU1R);
    glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(10, -10, ldm), LED::CalProbability::GLB_MU2R);
    glbSetOscParams(central_values, 1.5, LED::CalProbability::GLB_MU3R);
    glbSetOscillationParameters(central_values);
    glbSetRates();
