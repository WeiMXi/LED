...
char MYFILE1_cirp5[] = "../data/NOvA/LED/NOvA_numu_cir+5.dat";
char MYFILE2_cirp5[] = "../data/NOvA/LED/NOvA_anumu_cir+5.dat";
char MYFILE3_cirp5[] = "../data/NOvA/LED/NOvA_nue_LCNN_cir+5.dat";
char MYFILE4_cirp5[] = "../data/NOvA/LED/NOvA_nue_HCNN_cir+5.dat";
char MYFILE5_cirp5[] = "../data/NOvA/LED/NOvA_anue_LCNN_cir+5.dat";
char MYFILE6_cirp5[] = "../data/NOvA/LED/NOvA_anue_HCNN_cir+5.dat";

char MYFILE1_cirn5[] = "../data/NOvA/LED/NOvA_numu_cir-5.dat";
char MYFILE2_cirn5[] = "../data/NOvA/LED/NOvA_anumu_cir-5.dat";
char MYFILE3_cirn5[] = "../data/NOvA/LED/NOvA_nue_LCNN_cir-5.dat";
char MYFILE4_cirn5[] = "../data/NOvA/LED/NOvA_nue_HCNN_cir-5.dat";
char MYFILE5_cirn5[] = "../data/NOvA/LED/NOvA_anue_LCNN_cir-5.dat";
char MYFILE6_cirn5[] = "../data/NOvA/LED/NOvA_anue_HCNN_cir-5.dat";

char MYFILE1_muirp5[] = "../data/NOvA/LED/NOvA_numu_muir+0.005.dat";
char MYFILE2_muirp5[] = "../data/NOvA/LED/NOvA_anumu_muir+0.005.dat";
char MYFILE3_muirp5[] = "../data/NOvA/LED/NOvA_nue_LCNN_muir+0.005.dat";
char MYFILE4_muirp5[] = "../data/NOvA/LED/NOvA_nue_HCNN_muir+0.005.dat";
char MYFILE5_muirp5[] = "../data/NOvA/LED/NOvA_anue_LCNN_muir+0.005.dat";
char MYFILE6_muirp5[] = "../data/NOvA/LED/NOvA_anue_HCNN_muir+0.005.dat";

char MYFILE1_muirn5[] = "../data/NOvA/LED/NOvA_numu_muir-0.005.dat";
char MYFILE2_muirn5[] = "../data/NOvA/LED/NOvA_anumu_muir-0.005.dat";
char MYFILE3_muirn5[] = "../data/NOvA/LED/NOvA_nue_LCNN_muir-0.005.dat";
char MYFILE4_muirn5[] = "../data/NOvA/LED/NOvA_nue_HCNN_muir-0.005.dat";
char MYFILE5_muirn5[] = "../data/NOvA/LED/NOvA_anue_LCNN_muir-0.005.dat";
char MYFILE6_muirn5[] = "../data/NOvA/LED/NOvA_anue_HCNN_muir-0.005.dat";
...
int main(int argc, char* argv[]) {
    ...
    glbSetOscParams(true_values, 35, GLB_C1R);
    glbSetOscParams(true_values, -35, GLB_C2R);
    glbSetOscParams(true_values, -35, GLB_C3R);
    glbSetOscillationParameters(true_values);
    glbSetRates();

    /* Compute event rate spectra for the neutrino muon-like event */
    InitOutput(MYFILE1_cirn5, "");
    true_rates_N0 = glbGetRuleRatePtr(0, 0);
    true_rates_N1 = glbGetSignalRatePtr(0, 0);
    true_rates_N2 = glbGetBGRatePtr(0, 0);
    for (int i = 0; i <= n_bins1 - 1; i++) {
