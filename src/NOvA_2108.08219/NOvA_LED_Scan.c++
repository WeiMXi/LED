...
int main(int argc, char* argv[]) {
    ...
    // glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(1, -10, 2.481e-3 - sdm + mLightest2), LED::CalProbability::GLB_MU1R);
    // glbSetOscParams(central_values, LED::CalProbability::CalculateMuiR(1, -10, 2.481e-3 + mLightest2), LED::CalProbability::GLB_MU2R);
    ...
    // mLightest2 = LED::CalProbability::solve_masseq_vac(0, theParams) / LED::CalProbability::mum_to_eVinv(theR) / LED::CalProbability::mum_to_eVinv(theR);
    // glbSetOscParams(test_values, LED::CalProbability::CalculateMuiR(theR, -theAbsCR, 2.481e-3 - sdm + mLightest2), LED::CalProbability::GLB_MU1R);
    // glbSetOscParams(test_values, LED::CalProbability::CalculateMuiR(theR, -theAbsCR, 2.481e-3 + mLightest2), LED::CalProbability::GLB_MU2R);
